...
class MenuItem extends FlxSpriteGroup {
    ...
    public var distancePerItem:FlxPoint = new FlxPoint(75, 200);
    public var targetY:Int = 0;
    
    
    public function new(x:Float, y:Float, title:String = '?????', icon:String, texture:String) {
        super(0, 0);
        startPoint.x = x;
        startPoint.y = y;
        ...
        cutText(songName, title.toUpperCase(), songPanel.width-40);
    ...
    public function changeTexture(tex:String) {
        ...
        if (songPanel != null) songPanel.texture = tex;
    }
}